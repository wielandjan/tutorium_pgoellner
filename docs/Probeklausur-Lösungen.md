...
t - Codeanalyse ohne das Programm auszuführen
r
o
w
t
...
eine Methode, die sich selbst aufruft bis ein oder mehrere Abbruchbedingungen
...
t - Bessere Strukturierung von Projekten
r
o
w
t
...
- Name des Packages und Name der Klasse

- Im Stack werden Methoden und Variablenwerte gespeichtert
...
t - primitive Datentypen haben feste Speichergrößen (Objektdatentypen nicht)
r
o
w
t
...
Variablen speichern bei primitiven Datentypen den Wert, bei Objektdatentypen nur
